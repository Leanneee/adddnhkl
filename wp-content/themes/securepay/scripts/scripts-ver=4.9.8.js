jQuery(document).ready(function($){
	...
	if ($(window).width() <= 375) {
		console.log("YES");	
		$(".product-number-1").appendTo("#product-selection-1");
		$(".product-number-2").appendTo("#product-selection-2");
		$(".product-number-3").appendTo("#product-selection-3");
		$(".product-number-4").appendTo("#product-selection-4");
		$(".btn-close-detail").click(function(){
		    $(".product-number-1").hide();
		    $(".product-number-2").hide();
		    $(".product-number-3").hide();
		    $(".product-number-4").hide();
		});
